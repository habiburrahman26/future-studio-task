    ...
    <section className="py-2 sm:py-8">
      ...
      {items.length === 0 ? (
        ...
        <>
          <Button
            onClick={clear}
            className="my-5 w-22.5 bg-bg border border-red-300 text-fg hover:bg-red-400"
          >
            Clear all
          </Button>
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_352px] lg:items-start">
                  ...
                  <div className="flex min-w-0 flex-col justify-between py-1">
                    ...
                    <div className="mt-5 w-full flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className="col-start-2 row-start-1 self-end justify-self-end p-2 transition-colors hover:text-fg sm:col-start-3 sm:row-start-1 sm:self-center"
                      >
                        <svg
            ...
            <aside className="rounded-[26px] bg-surface p-6 shadow-(--shadow-border) lg:sticky lg:top-24">
              ...
              <Link
                href="/checkout"
                type="button"
                className="flex items-center justify-center mt-7 h-10 w-full rounded-md bg-primary font-medium text-primary-fg transition-colors hover:bg-ok"
              >
                Checkout
              </Link>
            </aside>
